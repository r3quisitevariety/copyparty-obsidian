...
>[!IMPORTANT] You can temporarily scope your attachments to a different folder (Settings --> Files and Links --> Default location for new attachments) to test the plugin out before fully committing.
